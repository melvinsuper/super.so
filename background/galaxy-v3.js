(function () {
  /*
    ...
    Do not hard-code one customer website here.
    Instead, each Super user adds their own site URL in the script tag using:

    data-super-galaxy-sites="https://example.super.site"

    You can also add multiple sites:
  ...
  */
  ...
  function getAllowedGalaxyHostnames() {
    ...
    /*
      ...
      This lets a user define:
      window.SuperReactBitsGalaxy = {
        allowedSites: ["https://example.super.site"]
      };
    */
    if (
      !rawSites &&
  ...
  function isSuperDashboardOrPreview() {
    ...
    var referrerHostname = normalizeGalaxyHostname(document.referrer);

    if (currentHostname === "app.super.so") return true;
    if (referrerHostname === "app.super.so") return true;
