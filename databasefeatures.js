(() => {
  ...
  function initAllTables(settings) {
    document.querySelectorAll(settings.selector).forEach(table => {
  ...
  function applyTheme(theme = {}) {
    ...
    style.textContent = `
      .super-db-tools {
        ...
        align-items: ${value("toolsAlign")} !important;
        gap: ${value("toolsGap")} !important;
        margin: ${value("toolsMargin")} !important;
        position: relative !important;
        z-index: 5 !important;
      }

      .super-db-tools .super-db-tools__bar {
        display: inline-flex !important;
        align-items: center !important;
        justify-content: flex-end !important;
        gap: ${value("barGap")} !important;
        min-height: ${value("barMinHeight")} !important;
        padding: ${value("barPadding")} !important;
        background: ${value("barBackground")} !important;
        border: 1px solid ${value("barBorderColor")} !important;
        border-radius: ${value("barRadius")} !important;
        box-shadow: ${value("barShadow")} !important;
      }

      .super-db-tools .super-db-tools__count {
        font-size: ${value("countFontSize")} !important;
        line-height: 1 !important;
        color: ${value("countColor")} !important;
        margin-right: 4px !important;
        white-space: nowrap !important;
      }

      .super-db-tools .super-db-tools__icon,
      .super-db-tools .super-db-tools__clear,
      .super-db-tools .super-db-tools__direction {
        appearance: none !important;
        border: 1px solid ${value("buttonBorderColor")} !important;
        background: ${value("buttonBackground")} !important;
        color: ${value("buttonColor")} !important;
        border-radius: ${value("buttonRadius")} !important;
        height: ${value("buttonHeight")} !important;
      ...
      .super-db-tools .super-db-tools__icon {
        width: ${value("buttonHeight")} !important;
        display: inline-flex !important;
        align-items: center !important;
      ...
      .super-db-tools .super-db-tools__icon:hover,
      .super-db-tools .super-db-tools__clear:hover,
      .super-db-tools .super-db-tools__direction:hover {
        background: ${value("buttonHoverBackground")} !important;
        color: ${value("buttonHoverColor")} !important;
        border-color: ${value("buttonHoverBorderColor")} !important;
      }

      .super-db-tools .super-db-tools__icon.is-active {
        background: ${value("activeBackground")} !important;
        color: ${value("activeColor")} !important;
        border-color: ${value("activeBorderColor")} !important;
        box-shadow: ${value("activeShadow")} !important;
      }

      .super-db-tools .super-db-tools__panel {
        width: min(${value("panelWidth")}, 100%) !important;
        display: grid !important;
        grid-template-columns: 1fr 1fr !important;
        gap: ${value("panelGap")} !important;
        padding: ${value("panelPadding")} !important;
        background: ${value("panelBackground")} !important;
        border: 1px solid ${value("panelBorderColor")} !important;
        border-radius: ${value("panelRadius")} !important;
        box-shadow: ${value("panelShadow")} !important;
      }

      .super-db-tools .super-db-tools__panel[hidden] {
        display: none !important;
      }

      .super-db-tools .super-db-tools__panel label {
        display: grid !important;
        gap: 6px !important;
        font-size: ${value("labelFontSize")} !important;
        font-weight: ${value("labelFontWeight")} !important;
        color: ${value("labelColor")} !important;
      }

      .super-db-tools .super-db-tools__panel input,
      .super-db-tools .super-db-tools__panel select {
        width: 100% !important;
        height: ${value("inputHeight")} !important;
        border: 1px solid ${value("inputBorderColor")} !important;
        border-radius: ${value("inputRadius")} !important;
        background: ${value("inputBackground")} !important;
        color: ${value("inputColor")} !important;
        font-size: ${value("inputFontSize")} !important;
        outline: none !important;
        padding: 0 10px !important;
      }

      .super-db-tools .super-db-tools__panel input:focus,
      .super-db-tools .super-db-tools__panel select:focus {
        border-color: ${value("focusBorderColor")} !important;
        box-shadow: ${value("focusShadow")} !important;
      }
  ...
  function observeTables(settings) {
    ...
    observer = new MutationObserver(() => {
      window.requestAnimationFrame(() => {
        observerSettings.forEach(settings => {
          applyTheme(settings.theme);
          initAllTables(settings);
        });
      });
