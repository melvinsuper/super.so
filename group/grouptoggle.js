(function () {
  ...
  const STYLE_ID = "super-group-toggle-default-closed-style";

  ROOT.classList.add("super-groups-preparing");
  ...
  const GROUP_TOGGLE_SELECTOR = ".notion-collection-group__section-toggle";
  ...
  function hideBrieflyBeforeClosing() {
    ...
    ROOT.classList.add("super-groups-preparing");
    ROOT.classList.remove("super-groups-ready");

    revealTimer = window.setTimeout(function () {
      ROOT.classList.remove("super-groups-preparing");
      ROOT.classList.add("super-groups-ready");
